...
import NoNextAppointments from "@/components/dashboard/NoNextAppointments";
...
const NextAppointment = async () => {
    ...
    const nextAppointment:any = upcomingAppointments[0];

    if(!nextAppointment) return <NoNextAppointments />

    const appointmentDate = parseISO(nextAppointment.date);
    const formattedDate = format(appointmentDate, "EEE, MMM dm yyyy")
